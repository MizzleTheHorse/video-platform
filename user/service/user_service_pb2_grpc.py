...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                ...
                response_deserializer=user__service__pb2.UserReply.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__service__pb2.UserReply.SerializeToString,
            ),
...
class UserService(object):
    ...
    def GetUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UserService/GetUser',
            ...
            user__service__pb2.UserReply.FromString,
    ...
    def PostUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserService/PostUser',
            user__service__pb2.UserRequest.SerializeToString,
            user__service__pb2.UserReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
